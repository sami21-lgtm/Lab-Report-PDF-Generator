...
// Assignment বাটনে ক্লিক করলে কি হবে
...
// Lab Report বাটনে ক্লিক করলে কি হবে
...
genBtn.onclick = function() {
    ...
    outputPage.innerHTML = `
        ...
        <div style="position: relative; z-index: 1; height: 100%; border: 3px solid #002b59; margin: 30px; padding: 50px; display: flex; flex-direction: column;">
            ...
            <div style="font-size: 16px; line-height: 1.8; margin-bottom: 40px; text-align: left;">
