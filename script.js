...
genBtn.onclick = function() {
    ...
    const d = {
        ...
        // তারিখ এবং সাল (২০২৬ সাপোর্ট করবে)
    ...
    outputPage.innerHTML = `
        ...
        <div style="position: relative; z-index: 1; height: 100%; display: flex; flex-direction: column;">
            ...
            <h1 style="text-align:center; color:#002b59; font-size: 22px; text-transform: uppercase; text-decoration: underline; margin-bottom: 20px;">
                ${currentMode === 'lab' ? 'Lab Report Submission' : 'Assignment Submission'}
            </h1>
            
            <div style="text-align: left; font-size: 16px; line-height: 1.8; color: #222;">
            ...
            <div style="margin-top: 40px; display: flex; flex-direction: column; gap: 30px;">
                <div style="text-align: center;">
                    <span style="background: #f0f4f8; padding: 4px 25px; border-radius: 20px; font-weight: bold; border: 1px solid #ccd; font-size: 13px; color: #002b59;">Submitted To</span>
                </div>
                ...
                <div style="text-align: center;">
                    <span style="background: #f0f4f8; padding: 4px 25px; border-radius: 20px; font-weight: bold; border: 1px solid #ccd; font-size: 13px; color: #002b59;">Submitted By</span>
                </div>
                <div style="padding-left: 20px; border-left: 4px solid #002b59; margin-left: 10px;">
            ...
            <div style="margin-top: auto; text-align: center; border-top: 1px solid #eee; padding-top: 15px;">
                <p style="font-family: serif; font-size: 15px; color: #002b59; font-style: italic; letter-spacing: 2px; text-transform: uppercase; font-weight: bold;">
...
// PDF ডাউনলোড (লোগো এবং ওয়াটারমার্ক সহ নিশ্চিত করা হয়েছে)
document.getElementById('downloadBtn').onclick = () => {
    const opt = {
        scale: 3,
        useCORS: true, // এটি লোগো দেখানোর জন্য গুরুত্বপূর্ণ
        allowTaint: true,
        logging: true
    };
